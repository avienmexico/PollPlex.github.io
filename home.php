                            ...
                            <form method="POST" id="ballotForm" action="submit_ballot.php">
                                ...
                                while ($row = $query->fetch_assoc()) {
                                    ...
                                    while ($crow = $cquery->fetch_assoc()) {
                                        ...
                                        $checked = '';
                                        if (isset($_SESSION['post'][$row['description']])) { 
                                            $value = $_SESSION['post'][$row['description']];
                                            if (is_array($value)) {
                                        ...
                                        $input = ($row['max_vote'] > 1) ?
                                            '<input type="checkbox" class="flat-red ' . $row['description'] . '" name="' . $row['description'] . "[]" . '" value="' . $crow['id'] . '" ' . $checked . '>' :
                                            '<input type="radio" class="flat-red ' . $row['description'] . '" name="' . $row['description'] . '" value="' . $crow['id'] . '" ' . $checked . '>';
